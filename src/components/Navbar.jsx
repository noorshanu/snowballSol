...
function Navbar() {
  ...
  return (
    <nav className=" py-1 bg-[]  ">
      <div className="container-wrapper flex  flex-col items-center justify-center relative">
        ...
        <div className="flex items-center space-x-6">
          <div className="flex items-center space-x-4 text-xl [&_a:hover]:opacity-70">
            <a target="_blank" href="https://twitter.com/SnowballSol" className=" text-2xl">
              <FaTwitter fill="#000" />
            </a>
            <a target="_blank" href="https://t.me/snowballso" className=" text-2xl">
              <FaTelegram fill="#000" />
            </a>
          </div>
